...
const getDefaultState = () => {
  return {
    ...
    dawAreaArr: [], // 绘制多边形覆盖物对象
    OutLineDataArr: [], // 地图边界线描边数组
    LineDataArr: [], // 地图边界线数组
    CoverDataArr: [], // 地图面数组
    NameDataArr: [], // 地图图标名称数组
    PositionDataArr: [], //地图区域位置数组
...
const getters = {
  ...
  dawAreaArr: state => state.dawAreaArr,
  PositionDataArr: state => state.PositionDataArr,
  OutLineDataArr: state => state.OutLineDataArr,
  LineDataArr: state => state.LineDataArr,
  CoverDataArr: state => state.CoverDataArr,
  NameDataArr: state => state.NameDataArr,
...
const mutations = {
  ...
  SET_OUTLINE_DATA_ARR: (state, data) => (state.OutLineDataArr = data),
  SET_DAW_AREA_ARR: (state, data) => (state.dawAreaArr = data),
  SET_LINE_DATA_ARR: (state, data) => (state.LineDataArr = data),
  SET_COVER_DATA_ARR: (state, data) => (state.CoverDataArr = data),
  SET_NAME_DATA_ARR: (state, data) => {
    state.NameDataArr = data;
  },
  SET_POSITION_DATA_ARR: (state, data) => {
    state.PositionDataArr = data;
  },
  ...
  SET_PLAN_APPROVE_STATUS : (state, data) => (state.planApproveStatus = data),
...
const actions = {
  ...
  setdawAreaArr: ({
    commit
  }, data) => commit('SET_DAW_AREA_ARR', data),
  // 地图边界线描边数组
  setOutLinArr: ({
    commit
  }, data) => commit('SET_OUTLINE_DATA_ARR', data),
  // 地图边界线数组
  setLineDataArr: ({
    commit
  }, data) => commit('SET_LINE_DATA_ARR', data),
  // 地图面数组
  setCoverDataArr: ({
    commit
  }, data) => commit('SET_COVER_DATA_ARR', data),
  // 地图图标名称数组
  setNameDataArr: ({
    commit
  }, data) => commit('SET_NAME_DATA_ARR', data),
  // 地图位置数组
  setPositonDataArr: ({
    commit
  }, data) => commit('SET_POSITION_DATA_ARR', data),
  setShowRoute: ({
    commit
  }, data) => {
