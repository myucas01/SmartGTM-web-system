<template>
	<el-dialog :visible.sync="dialogVisible" :before-close="handleClose" :append-to-body="true">
		...
		<div class="table">
			<el-table class="smart_table_deep" :data="tableList" size="mini" border fit style="width: 100%">
