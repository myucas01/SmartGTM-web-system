            ...
            .then(res => {
              ...
              let orgId =
                resCode == 200 && resData.seniorOrgId != undefined
                  ? resData.seniorOrgId
                  : '5074727057550190748'
              const orgType = resCode == 200 ? resData.orgType : 999
              ...
              const businessLevel = resCode == 200 ? resData.businessLevel : ''
              ...
              if (menuList.length > 0) {
                ...
                // })
                // menuList.map(item => {
                //   if (item.name == 'route-planning') {
                //     item.list.map(el => {
                //       if (el.menuName == '全局配置') {
                //         el.list = el.list.filter(
                //           ele => ele.menuName != '客户规模'
                //         )
                //       }
                //     })
                //   }
              ...
              this.$cookies.set('orgType', orgType, {
                expires: '1M',
                domain: location.hostname
              })
              ...
              this.$cookies.set('businessLevel', businessLevel, {
                expires: '1M',
                domain: location.hostname
              })
    ...
    > div {
      ...
      > form {
        ...
        .username:before {
          ...
          height: 20px;
          text-indent: -9999px;
          background: url('/img/login-name.png') no-repeat 0 0;
          background-size: 100% 100%;
        }
        .pwd:before {
          width: 20px;
